...
namespace Mathematics_UnitTests
{
	...
	public:
		...
		{
			// Arrange
			Vector3 left = Vector3(0.0f);
			Vector3 right = Vector3(1.0f);

			// Act
			Vector3 total = left + right;
		...
		{
			// Arrange 
			Vector3 left = Vector3(1.0f, 2.0f, 3.0f);
			Vector3 right = left;
		...
		TEST_METHOD(Vector3_MultiplyByScalar)
		{
			...
			// Act
			Vector3 newVector = vector * scalar;
		...
		{
			// Arrange
			Vector3 vector = Vector3(1.0f, 1.0f, 1.0f);

			// Act
			Vector3 negatedVector = vector.Negate();
		...
		TEST_METHOD(Vector3_Normalise)
		{
			...
			float expected = RoundToNDecimalPlaces(0.577351f, 4);

			// Act
			Vector3 negatedVector = vector.Normalise();
		...
		{
			// Arrange
			Vector3 vector = Vector3(9.0f, 2.0f, 7.0f);
		...
		{
			// Arrange
			Vector3 vectorA = Vector3(9.0f, 2.0f, 7.0f);
			Vector3 vectorB = Vector3(4.0f, 8.0f, 10.0f);
		...
		TEST_METHOD(Vector3_AngleInDegree)
		{
			...
			// Act
			float angle = vectorA.AngleInDegrees(vectorB);
