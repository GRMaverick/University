...
SequentialPhysicsApp::SequentialPhysicsApp(void)
{
	this->Initialise();
}
SequentialPhysicsApp::~SequentialPhysicsApp(void)
...
void SequentialPhysicsApp::Initialise(void)
{
	std::cout << "Initialising Physics Sequential Application" << std::endl << std::endl;
...
void SequentialPhysicsApp::Run(void)
{
	std::cout << "Running Physics Sequential Application" << std::endl;
...
void SequentialPhysicsApp::Update(float deltaTime)
{
...
void SequentialPhysicsApp::Render(int frame)
{
