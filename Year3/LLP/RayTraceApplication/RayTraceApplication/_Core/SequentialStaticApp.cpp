...
SequentialStaticApp::SequentialStaticApp(void)
{
	this->Initialise();
}
SequentialStaticApp::~SequentialStaticApp(void)
...
void SequentialStaticApp::Initialise(void)
{
	std::cout << "Initialising Static Sequential Application" << std::endl << std::endl;
...
void SequentialStaticApp::Run(void)
{
	std::cout << "Running Static Sequential Application" << std::endl;
...
void SequentialStaticApp::Update(float deltaTime)
{

}
void SequentialStaticApp::Render(int frame)
{
