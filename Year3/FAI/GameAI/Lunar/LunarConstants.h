...
const float	 kLandingBonus				 = 9999.0f; //Todo: Change these values
const double kDistWeight				 = 0.9;  //Todo: Change these values
const double kRotWeight					 = 0.7;  //Todo: Change these values
const double kAirTimeWeight				 = 0.35;  //Todo: Change these values
