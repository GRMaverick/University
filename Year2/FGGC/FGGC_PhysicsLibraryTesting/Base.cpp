...
HRESULT Base::Initialise(HINSTANCE hInstance, int nCmdShow)
{
...
HRESULT Base::InitShadersAndInputLayout()
{
	HRESULT hr;
...
HRESULT Base::InitWindow(HINSTANCE hInstance, int nCmdShow)
{
	// Register class
	WNDCLASSEX wcex;
...
HRESULT Base::CompileShaderFromFile(WCHAR* szFileName, LPCSTR szEntryPoint, LPCSTR szShaderModel, ID3DBlob** ppBlobOut)
{
	HRESULT hr = S_OK;
