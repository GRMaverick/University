...
public:
	...
	Vector3& operator+=(Vector3 u);	// Vector3 addition
	Vector3& operator-=(Vector3 u);	// Vector3 subtraction
	Vector3& operator*=(float s);	// scalar multiply
...
public:
	...
	Vector3	v;	// Vector3 part: v.x, v.y, v.z
...
inline	Vector3	Quaternion::GetVector3(void)
{
