...
void SX1::Draw(){
	...
	else if (_aBool && _key == 'd')
		glRotatef(15.0f, 0.0f, 0.0f, -1.0f);
	else if (_wBool && _key == 's')
		glRotatef(15.0f, -1.0f, 0.0f, 0.0f);
	else if (_sBool && _key == 'w')
		glRotatef(15.0f, 1.0f, 0.0f, 0.0f);
...
// Setters
void SX1::SetPosition(Vector3* position){
	_position = position;
}
void SX1::SetTexture(Texture2D* texture){
	_texture = texture;
}
void SX1::SetMesh(OBJMesh* mesh){
	_mesh = mesh;
}
...
Vector3* SX1::GetPostion(){
	return _position;
}
Texture2D* SX1::GetTexture(){
	return _texture;
}